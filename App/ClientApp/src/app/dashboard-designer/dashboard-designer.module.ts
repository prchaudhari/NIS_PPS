...
import {
  CustomerInformationComponent,CustomerContactComponent,AccountInformationComponent, ImageComponent, VideoComponent, SummaryAtGlanceComponent,
...
@NgModule({
  declarations: [AddDashboardDesignerComponent, ViewDashboardDesignerComponent, CustomerInformationComponent,CustomerContactComponent,
  ...
  entryComponents: [
    CustomerInformationComponent,CustomerContactComponent,AccountInformationComponent, ImageComponent, VideoComponent, SummaryAtGlanceComponent, TransactionDetailsComponent, SavingAvailableBalanceComponent,
